...
// ########################################
static void software_SPI_writeStructures(GPIO_pin_t *struct_ptr,
 ...
 *
 */
void software_SPI_addPins(GPIO_TypeDef *GPIO_MOSI, uint32_t Pin_MOSI,
...
static inline void MOSI_toHigh() { MOSI_pin.GPIO->BSRR = MOSI_pin.Pin; }

static inline void MOSI_toLow() { MOSI_pin.GPIO->BRR = MOSI_pin.Pin; }

static inline void CLK_toHigh() { CLK_pin.GPIO->BSRR = CLK_pin.Pin; }

static inline void CLK_toLow() { CLK_pin.GPIO->BRR = CLK_pin.Pin; }
